...
export const tasks: Task[] = [
  ...
  },
  {
    ...
    description:
      "Set up user authentication with JWT and role-based access control",
    status: "in-progress",
    priority: "high",
    assigneeId: "user-4",
    createdById: "user-1",
  ...
  },
  {
    ...
    description:
      "The pagination in the task list is not working correctly when filtering by status",
    status: "review",
    priority: "medium",
    assigneeId: "user-2",
    createdById: "user-4",
    ...
    comments: [
      {
        ...
        userId: "user-2",
        content:
          "I've identified the issue. It's related to the filter state not being reset when changing pages.",
  ...
  },
  {
    ...
    description:
      "Improve performance of dashboard queries by adding indexes and optimizing joins",
    status: "done",
    priority: "high",
    assigneeId: "user-5",
    createdById: "user-1",
    ...
    comments: [
      {
        ...
        userId: "user-5",
        content:
          "Added indexes to the most frequently queried columns. Performance improved by 40%.",
      ...
      },
      {
        ...
        userId: "user-1",
        content:
          "Great work! Let's monitor the performance over the next few days.",
  ...
  },
  {
    ...
    description:
      "Design and implement an interactive onboarding tutorial for new users",
    status: "todo",
    priority: "low",
    assigneeId: null,
    createdById: "user-4",
    ...
    comments: [
      {
        ...
        userId: "user-2",
        content:
          "Dark mode implementation is complete. Please review the color scheme.",
